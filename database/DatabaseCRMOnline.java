...
public class DatabaseCRMOnline {
    ...
    public static void connectDB() throws SQLException {
        ...
        try {
            conn = DriverManager.getConnection("jdbc:sqlserver://sql11.freemysqlhosting.net;databaseName=sql11418313;user=sql11418313;password=sql55.");
    ...
    static class UserDB {
         ...
         * @throws SQLException throws a SQLException
         */
        private static boolean hasExistUser(String id) throws SQLException {
    ...
    static class ScheduleDB {
        ...
        public static boolean hasExist(String TableName, String ColumnName, String value) throws SQLException {
            String selectSql = "SELECT CASE WHEN EXISTS (SELECT TOP 1 * FROM " + TableName + " WHERE " + ColumnName + "= '" + value + "') THEN CAST (1 AS BIT) ELSE CAST (0 AS BIT) END";
